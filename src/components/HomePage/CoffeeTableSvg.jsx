...
// const smokeAnimation = {animation: `animation: ${smoke} 6s ease infinite`};
// const writingAnimation = {animation: `animation: ${writing} 6s ease infinite`};
